...
export type EnumTypes = {[key: string]: string};
...
export type ProjectType = 'CREAMS_MAIN' | 'TENANT_H5';
...
export interface InterfaceModel {
     ...
     * 用于生成枚举 type 类型
     */
    relatedTypeInterfaceName?: Map<string, string>;
    // 用于 生成 从 公共的 Types 中导出 对应类型
    EnumStringTypes?: string[];
    interfacesEnumTypes?: string[];
}
